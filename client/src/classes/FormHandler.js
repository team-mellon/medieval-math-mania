...
class FormHandler {
  ...
  static createSignupForm () {
    ...
    var signup_firstname_div = this.createInputBoxWithLabel("signup", "Firstname", "firstnameInput", "text", "fname", false);
    var signup_lastname_div = this.createInputBoxWithLabel("signup", "Lastname", "lastnameInput", "text", "lname", false);
