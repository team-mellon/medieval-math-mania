export const tutorialSteps = [
  ...
  "To attempt a solution, use the number keys, the period, and the minus sign to choose a multiplicand and the enter key to fire the catapult and check your solution.",
