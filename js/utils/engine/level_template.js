...
function loadLevel() {
  ...
  bg_color = levels[current_level - 1].color;
  ...
  leftS = {
    images: ["res/level" + current_level + "/left.png"],
    frames: {width:1920, height:1440, count:6, regX: 0, regY:0, spacing:0, margin:0},
    framerate: 6
  };

  rightS = {
    images: ["res/level" + current_level + "/right.png"],
    frames: {width:1920, height:1440, count:6, regX: 0, regY:0, spacing:0, margin:0},
    framerate: 6
  };
...
function loadImage() {
	...
	preload.loadFile("res/level" + current_level + "/center.png");
	preload.loadFile("res/level" + current_level + "/left-center.png");
	preload.loadFile("res/level" + current_level + "/right-center.png");
	preload.loadFile("res/level" + current_level + "/body.png");
	preload.loadFile("res/level" + current_level + "/left.png");
	preload.loadFile("res/level" + current_level + "/right.png");
...
function createLevel() {
  ...
  structure_left = createLevelSprite(leftS, structureX, structureY, "center", 0, "bottom", -structureY / 2, "image");
